...
file = 'R2-T-06-02-30-TR-151-AW3-D.xlsx';

Data = readmatrix(file);

acc_A = Data(1:end,3); % On the rail feet (north)
acc_B =  Data(1:end,4); % On the slab
acc_C =  Data(1:end,5); % close to the slab
acc_D =  Data(1:end,6); % On the rail feet (south)
