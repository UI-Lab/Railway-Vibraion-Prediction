...
T_frequency_domain = table(f_center,AMP_A_dB,AMP_B_dB,AMP_C_dB,'VariableNames',{'Frequency(Hz)','A','B','C'});
...
set(gca,'XColor', [0,0,0], 'YColor', [0,0,0]);
set(gca, 'XLim', [f_single(1), 250]);
% Set font and color for axis ticks
set(gca, 'FontName', 'Times New Roman', 'FontSize', 14); % Tick labels
% Set axis labels with font size 22 and black color
xlabel('Frequency [Hz]', 'FontName', 'Times New Roman', ...
       'FontSize', 20, 'Color', [0,0,0]);
ylabel('Amplitude [m/s^{2}/Hz]', 'FontName', 'Times New Roman', ...
       'FontSize', 20, 'Color', [0,0,0]);
% Add black box around the plot
set(gca, 'Box', 'on', 'LineWidth', 1.2);
% Finish plotting
...
% Set logarithmic scale for x-axis
set(gca, 'XScale', 'log');
set(gca, 'XTick', [2,4,8,16,31.5,63,128,256], 'XColor', [0,0,0], 'YColor', [0,0,0]);
set(gca, 'XLim', [f_center(1), 256]);
% Set font and color for axis ticks
set(gca, 'FontName', 'Times New Roman', 'FontSize', 14); % Tick labels
% Set axis labels with font size 22 and black color
...
writetable(T_frequency_domain,fullfile(path,filename),'sheet',file(1:end-4),'Range','H1:M27');
