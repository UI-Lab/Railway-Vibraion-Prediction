...
acc_A = Data(1:end,2)*(2.38419e-6)*4.67; % On the rail feet (north)
acc_B = Data(1:end,3)*(2.38419e-6)*4.67; % On the slab
acc_C = Data(1:end,4)*(2.38419e-6)*4.67; % close to the slab
